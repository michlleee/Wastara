...
const PickupRequestCard = ({ trashDescription, placeDescription, status, index, date, showButton, onCancel }) => {
  const statusConfig = {
    pending: {
      bg: "bg-amber-50",
      text: "text-amber-700",
  ...
  return (
    <div className="group bg-white/80 backdrop-blur-sm shadow-sm border border-slate-200/60 p-3 sm:p-4 lg:p-6 rounded-xl sm:rounded-2xl flex flex-col hover:shadow-lg hover:shadow-slate-200/50 hover:border-slate-300/60 transition-all duration-300 hover:-translate-y-0.5">
      <div className="flex flex-col xs:flex-row justify-between items-start gap-3 xs:gap-0 mb-3 sm:mb-4">
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div>
            <p className="font-semibold text-slate-900 text-base sm:text-lg">Pickup #{index + 1}</p>
            {date && (
        ...
        >
          <div className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full ${currentStatus.dot}`}></div>
      ...
      <div className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
        <div className="p-3 sm:p-4 rounded-lg sm:rounded-xl bg-slate-50/80 border border-slate-200/60 hover:bg-slate-100/80 transition-colors">
          <div className="flex items-center gap-2 mb-2">
            <Trash2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-600" />
            <p className="font-medium text-slate-900 text-sm">Trash Description</p>
          </div>
        ...
        <div className="p-3 sm:p-4 rounded-lg sm:rounded-xl bg-slate-50/80 border border-slate-200/60 hover:bg-slate-100/80 transition-colors">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="font-medium text-slate-900 text-sm">Location Description</p>
          </div>
          <p className="text-slate-700 text-sm leading-relaxed pl-5 sm:pl-6">
