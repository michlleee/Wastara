const OrganizerSidebarIcon = ({ label, icon }) => {
  return (
    <div className="group flex flex-col items-center cursor-pointer">
      ...
      <span className="text-xs text-white group-hover:text-orange-400 transition-colors duration-300 mt-1">
        {label}
      </span>
    </div>
  )
...
export default OrganizerSidebarIcon